...
install_x-ui() {
    ...
    echo -e "Please make sure that this port is not being in use by other programs，${yellow}and make sure that port 54321 has been released${plain}"
#    echo -e "If you want to modify 54321 to another port, enter the x-ui command to modify, and also make sure that the modified port is also allowed"
    echo -e ""
